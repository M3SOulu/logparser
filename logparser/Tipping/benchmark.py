...
benchmark_settings = {
    ...
    "Hadoop": {
        ...
        "special_blacks": [r"task_\S+", r"attempt_\S+", r"container_\S+"],
        "tau": 0.5,
    },
    "Spark": {
    ...
    "Linux": {
        ...
        "symbols": "()[]{}=,*&",
        "special_whites": [r"restart."],
        "special_blacks": [r"(\d+\.){3}\d+", r"[A-Z][a-z]{2} [A-Z][a-z]{2} \d{2} \d{2}:\d{2}:\d{2} \d{4}", r"user \S+"],
        "tau": 0.5,
    },
    "Android": {
        ...
        "symbols": "()[]{}=,*&|:;'." + '"',
        "special_whites": ["Acquiring", "Releasing" r"\S+="],
        "special_blacks": [
            r"(/[\w-]+)+",
            r"([\w-]+\.){2,}[\w-]+",
    ...
    "OpenSSH": {
        ...
        "symbols": "()[]{}=,*&:;_",
        "special_whites": [],
        "special_blacks": [r"root", r"sshd", r"git", r"uucp", r"mysql", r"ftp"],
        "tau": 0.5,
    },
    "OpenStack": {
        ...
        "symbols": "()[]{}=,*:_",
        # "special_whites": [r"[A-Z]{2,}(?:_[A-Z])*" ,r"Started", r"Paused", r"Stopped", r"Resumed", r"build", r"destroy", r"spawn"],
        "special_whites": [r"[A-Z]{2,}(?:_[A-Z])*"],
        "special_blacks": [],
        "tau": 0.9,
    },
